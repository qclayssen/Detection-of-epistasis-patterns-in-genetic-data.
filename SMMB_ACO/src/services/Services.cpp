...
//-----------------------------------------
// Services : print_vector
//-----------------------------------------
void Services::print_vector(std::vector<double> const& v, bool carriage_return)         // double
{
    cout << "[ ";
    for (auto& i : v)
    {
...
void Services::print_vector(std::vector<unsigned> const& v, bool carriage_return)        // unsigned
{
    cout << "[ ";
    for (auto& i : v)
    {

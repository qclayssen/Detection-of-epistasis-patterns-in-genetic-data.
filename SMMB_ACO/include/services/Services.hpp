...
public:
    ...
    static void print_vector(std::vector<double> const& v, bool carriage_return=true);
    static void print_vector(std::vector<unsigned> const& v, bool carriage_return=true);
